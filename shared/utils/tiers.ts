...
import { TIER_THRESHOLDS, HINT_GOLD_LOCK_LEVEL } from './constants'
 ...
 *
 * @param rawScore   Score before penalty.
 * @param penalties  Array of penalty ratios (e.g. [0.01, 0.03]).
 */
...
// ---------------------------------------------------------------------------
// Display helpers (used only by the frontend, but kept here so the server
// can also format tier labels for share-text generation).
// ---------------------------------------------------------------------------
...
export const TIER_EMOJI: Record<OutcomeTier, string> = {
  gold:       '🏆',
  silver:     '🥈',
  bronze:     '🥉',
  finished:   '✅',
