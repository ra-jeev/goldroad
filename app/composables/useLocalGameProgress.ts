...
export function useLocalGameProgress() {
  ...
  return {
    ...
    setSolveTimerState,
    recordRun,
    recordArchiveCompletion: localState.recordArchiveCompletion,
    isRoadModeSolved: localState.isRoadModeSolved,
    archiveCompletionByGame: localState.archiveCompletionByGame,
