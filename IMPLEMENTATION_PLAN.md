...
- **Today's solved card keeps v1's result-and-share structure without duplicating the celebration's visual weight**: a "Yay! You got to the finish 🎉" line, a restrained result preview, and the gold primary Share action beneath. Both live celebration variants also expose sharing. The medal "+1" is golden text (v1's), never a green badge, and the medal count bumps on arrival.
